...
/**
 * Simple timer for measurement of run time. It calculates user, system, cpu time used by current
 * thread and total "wall clock" time.
 *
 * @author Artur Czajka
 *
 */
...
public class RealTimer {
        ...
        /**
         * System time is time spent running system calls on behalf of the application (e.g. I/O).
         *
        ...
        public String toString() {
                return String.format("Real: %.5fs User: %.5fs Sys: %.5fs CPU: %.5fs",
                        getRealTime(mulFactor), getUserTime(mulFactor), getSystemTime(mulFactor),
                        getCpuTime(mulFactor));
        }
